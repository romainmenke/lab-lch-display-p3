...
export function polar_premultiply(color, alpha, hueIndex) {
...
export function polar_un_premultiply(color, alpha, hueIndex) {
    // given a color in a cylindicalpolar colorspace
    // and an alpha value
    // return the actual color.
...
export function hsl_premultiply(color, alpha) {
